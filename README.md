...
<code>apt update && apt install git python3 -y && git clone -b stable https://github.com/sharkgay/Trash-userbot && cd LidFax-userbot && pip install -r requirements.txt && python3 -m hikka</code><br.>
